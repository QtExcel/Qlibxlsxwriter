...
- libxlsxwriter is a C library for creating Excel XLSX files. :+1:
    ...
    - No. Libxlsxwriter is designed only as a file writer. It cannot read or modify an existing Excel file. See [FAQ](http://libxlsxwriter.github.io/faq.html) for more information.
